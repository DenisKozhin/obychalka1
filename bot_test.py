...
# Middleware для работы с базой данных с правильным методом __call__
...
async def main():
    ...
    # Регистрация только DbSessionMiddleware
